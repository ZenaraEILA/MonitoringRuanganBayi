                    ...
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch p-0" style="padding-left: 2.5rem !important;">
                                <input class="form-check-input" type="checkbox" id="is_on_about_page" name="is_on_about_page" value="1" {{ old('is_on_about_page') ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="job_title" name="job_title" value="{{ old('job_title') }}" placeholder="Contoh: IoT Engineer">
                        </div>
